...
Public Class Form1
    'These Dim statements all tell VB to name and make space for these variables, which you instantiate (create) later.
    'Note they don't contain `()` after the `As OleDb...`, since we do not yet want to instantiate them.
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'This line creates the object that will translate changes to the dataset, when sent to the database, into the required SQL commands (UPDATE, INSERT and DELETE).
